...
<!--ts-->
   * [心肺训练：计划和进阶](#心肺训练计划和进阶)
      ...
      * [针对健康、体适能和减肥为目的的一般指南](#针对健康体适能和减肥为目的的一般指南)
         ...
         * [运动进阶](#运动进阶)
            * [超负荷原则](#超负荷原则)
            * [SAID 原则=专项性原则](#said-原则专项性原则)
               * [法特雷克训练法 Fartlek](#法特雷克训练法-fartlek)
         * [6-17岁青少年运动指南](#6-17岁青少年运动指南)
         * [18-64岁人运动之南](#18-64岁人运动之南)
      * [运动的强度](#运动的强度)
         * [心率](#心率)
            * [最大心率](#最大心率)
            * [心率储备（HRR）[重要]](#心率储备hrr重要)
         * [自感用力度 RPE[重要]](#自感用力度-rpe重要)
            * [利用 RPE 设计训练负荷](#利用-rpe-设计训练负荷)
         * [代谢当量或者摄氧量（VO2）](#代谢当量或者摄氧量vo2)
         * [热量消耗](#热量消耗)
         * [谈话测试](#谈话测试)
...
P397,间歇训练一般是1：1或者1：2的运动-恢复比。15-30s 的较高强度 HIIT 可以有效募集并刺激 II型肌纤维，但是从总体代谢的角度来看，仍然属于有氧训练。
...
冷身训练期主要目的在于防止运动结束后血液在肢体淤积。运动时产生的“肌肉泵效应”可引起血液在下肢淤积、回心血量下降、重要脏器血流量下降（如大脑，可能会产生眩晕症状），导致静脉回心血量显著下降。
...
运动方案的早期阶段，最适宜操作的运动变量是运动时间，没一到两周增加运动时间10%或者5-10分钟。如果可以坚持，再增加频率和强度。
...
从第二区的下端进阶到上端。训练有素的非运动员往往会花费50%的时间在2区训练。
